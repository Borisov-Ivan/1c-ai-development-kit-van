...
- `.cursor/agents/`: `onec-code-reviewer.md` (диета), перенос `CHANGELOG.md`. Эталон сравнения находок после диеты — фрагменты BSL в `.cursor/docs/standard/std-06-code-modules.md` (файл поставки; новый `.bsl` и `temp/` не входят в scope).
