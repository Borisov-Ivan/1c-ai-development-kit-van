...
Используй поиск по репозиторию (Grep/SemanticSearch; если смысловой поиск недоступен — Grep и Glob, сессию не стопить) для проверки имён методов БСП и нахождения существующих паттернов обработчиков в кодовой базе.
