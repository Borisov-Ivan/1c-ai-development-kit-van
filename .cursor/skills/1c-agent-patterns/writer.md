...
**Intent-бриф:** каждый промпт ниже содержит цель / ограничения / scope / критерий готовности. Не заменять их микрошагами «как писать код». Запрещено просить пересказать рассуждения и писать «не думай долго».
