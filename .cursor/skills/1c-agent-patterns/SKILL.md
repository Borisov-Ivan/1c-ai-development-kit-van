...
Task(
  ...
  prompt="Проверь качество кода для [feature].
         ...
         4. CONTEXT_SAFETY: клиентские Перем базовой формы не используются
            ...
            Нарушение → CRITICAL.
         5. CONDITIONAL_ACTION_GATE: если перед единственным оставшимся
...
**Version**: 2.1
**Changes**: Added CONDITIONAL_ACTION_GATE shared block, writer GATES/self-check, reviewer HALT-compliance check (rule 23)
