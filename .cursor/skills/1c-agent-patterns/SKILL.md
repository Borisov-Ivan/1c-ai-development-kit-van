...
Task(
  ...
  prompt="Проведи ревью технического задания по ЗНИ с позиции архитектора
         ...
         4. Deployment — план развёртывания корректен? Откат описан?
            Breaking change учтён в развёртывании?
         5. Clarity — внешний разработчик/заказчик поймёт требования
            без погружения в проект?
