...
Task(
  ...
  prompt="Реализуй задачу N для [feature].
         ...
         При правке метода с &ИзменениеИКонтроль — ТОЛЬКО код внутри #Вставка/#КонецВставки.
         Код вне директив — типовой, НЕПРИКОСНОВЕНЕН. Нарушение = поломка расширения.
...
Task(
  ...
  prompt="Исправь ошибку для [feature/модуль].
         ...
         расширением существующей функции.
         При правке метода с &ИзменениеИКонтроль — ТОЛЬКО код внутри #Вставка/#КонецВставки.
         Код вне директив — типовой, НЕПРИКОСНОВЕНЕН.",
  subagent_type="onec-code-writer",
  model="fast"
)
```
