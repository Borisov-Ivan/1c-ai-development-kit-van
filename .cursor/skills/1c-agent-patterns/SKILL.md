...
**Version**: 2.0
**Changes**: Shared instruction blocks (DATA_CONTRACT_GATE, INTEGRATION_CONTRACT_GATE, EXTENSION_GUARD, CONTEXT_SAFETY), adaptive model selection for writer, restructured Writer templates with priority grouping, HALT-compliance check in Reviewer templates
