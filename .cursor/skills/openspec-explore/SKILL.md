...
**Приоритет слота «Дальше»:** предложение панели — когда без картинки легко перепутать части, слои или случаи, тот же критерий, что в навыке визуального объяснения. Иначе при цепочке точек — `/opsx:explain` (пошаговый разбор с кодом), одной строкой, без второго брифа. Панель и разбор в одном сообщении **запрещено**. Если печатается блок `## Постановка ЗНИ` — варианта панели нет ни в «Дальше», ни в оставшейся строке «Следующий шаг» с командой создать ЗНИ.
