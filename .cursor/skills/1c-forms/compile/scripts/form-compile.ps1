...
if (-not $FormVersion) {
	$FormVersion = Resolve-FormVersion -StartPath $OutputPath
}
...
# Reset and rebuild properly (dead code above was emitting before title — only this block is used)
$script:xml = New-Object System.Text.StringBuilder 8192
$script:nextId = 1
