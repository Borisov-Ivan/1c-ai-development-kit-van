...
- **«карта точек»**, **«карточка точки»** (`/opsx:explain`) — допустимы: карта = список имён и классов до прохода; карточка = разбор одной точки с фрагментом кода. Не путать с success-spam («прошли все точки»).
