...
- **`/opsx:overview`** (файл `temp/overview-*.md`) — слой «документ заказчику / ФА / аналитик»: ситуация и эффект простым языком, не калька `design.md` и не названия механизмов («автомат», «ядро»); см. `.cursor/skills/openspec-overview/templates/style-checklist.md` § Голос аналитика.
