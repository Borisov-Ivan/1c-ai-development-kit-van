...
3. Показать обязательный бриф: что будет изменено в ЗНИ, какие артефакты затронуты, нужен ли architect, где неоднозначности. До подтверждения пользователя — никаких правок.
